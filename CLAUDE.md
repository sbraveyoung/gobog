...
- `IsAI()` / `AILabel()` — `ai:` front-matter marks AI-generated / -assisted content. Truthy values render a "🤖 AI powered" badge; any other non-empty, non-falsy string is treated as a model name and shown verbatim ("🤖 claude", "🤖 GPT-4o"). Authors can write `ai: false` to mean "I wrote this myself".
